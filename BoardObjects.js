...
// TODO FIX 
alert("The images are not going to load rn so we should fix this.");

// Globals TODO figure out which ones you need here versus in the other 
var size = 60;
...
var gameRoad = function(college1, college2) {
...
var gameBoard = function() {
  ...
  //TODO make a loop if you feel like it 
  ...
  for (var i = 0; i < this.num_colleges; i++) {
    ...
    colleges[i] = new gameCollege(this.tiles[colleges_tiles[i]].x_coords[colleges_coords[i]],
      this.tiles[colleges_tiles[i]].y_coords[colleges_coords[i]], adj_tiles_loop);
  }
  ...
  for (var i = 0; i < connections.length; i++) {
    roads.push(new gameRoad(this.colleges[connections[i][0]], this.colleges[connections[i][1]]));
  }
  this.roads = roads;
}
