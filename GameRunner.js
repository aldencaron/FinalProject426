function RunGame() {
        ...
        for (var i = 0; i < game.num_colleges; i++) {
            if (game.colleges[i].available) {
                if (game.pointDistance(x, y, game.colleges[i].x, game.colleges[i].y) <= game.colleges[i].radius) {
                    ...
                    $.ajax({
                        url: url_base + "SettlersOfCarolina.php/Colleges/" + game.colleges[i].id,
                        type: "POST",
                        dataType: "json",
                        async: false,
        ...
        for (var i = 0; i < game.num_roads; i++) {
            if (game.roads[i].available) {
                if (game.pointDistance(x, y, game.roads[i].x_center, game.roads[i].y_center) <= game.roads[i].radius) {
                    ...
                    // TODO ajax call here
                    $.ajax({
                        url: url_base + "SettlersOfCarolina.php/Roads/" + game.roads[i].id,
                        type: "POST",
                        dataType: "json",
                        async: false,
    ...
    var moveRobber = function(event) {
        ...
        for (var i = 0; i < game.num_tiles; i++) {
            ...
            if (game.checkLeft(game.tiles[i].x_coords[4], x) &&
                ...
                $.ajax({
                    url: url_base + "SettlersOfCarolina.php/Tiles/" + game.tiles[i].id,
                    type: "POST",
                    dataType: "json",
                    async: false,
    ...
    var diceRoll = function() {
        $.ajax({
            url: url_base + "SettlersOfCarolina.php/DiceRolls/" + game.turn_number,
            type: "GET",
            dataType: "json",
            async: false,
    ...
    var turnEnd = function() {
        ...
        // Update player cards
        $.ajax({
            url: url_base + "SettlersOfCarolina.php/Cards/" + game.player.id,
            type: "POST",
            dataType: "json",
        ...
        $.ajax({
            url: url_base + "SettlersOfCarolina.php/Players/" + game.player.id,
            type: "POST",
            dataType: "json",
        ...
        game.turn_number++;
        $.ajax({
            url: url_base + "SettlersOfCarolina.php/Turns",
            type: "POST",
            dataType: "json",
            async: false,
            ...
            if (game.turn_number == game.player.id) {
                ...
                var c = setInterval(function() {
                    if (my_turn) {
                        ...
                        $.ajax({
                            url: url_base + "SettlersOfCarolina.php/Tiles/getAll",
                            type: "GET",
                            dataType: "json",
                            async: false,
                        ...
                        $.ajax({
                            url: url_base + "SettlersOfCarolina.php/Colleges/getAll",
                            type: "GET",
                            dataType: "json",
                            async: false,
                        ...
                        $.ajax({
                            url: url_base + "SettlersOfCarolina.php/Roads/getAll",
                            type: "GET",
                            dataType: "json",
                            async: false,
                        ...
                        $.ajax({
                            url: url_base + "SettlersOfCarolina.php/Players/getAll",
                            type: "GET",
                            dataType: "json",
                            async: false,
                        ...
                        $.ajax({
                            url: url_base + "SettlersOfCarolina.php/Cards/getAll",
                            type: "GET",
                            dataType: "json",
                            async: false,
